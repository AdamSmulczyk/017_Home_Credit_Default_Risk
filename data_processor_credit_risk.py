...
get_convert_types_2 = FunctionTransformer(convert_types_2)
...
ori = OrdinalEncoder()
ori_2 = OrdinalEncoder(handle_unknown='use_encoded_value', unknown_value=-1)
...
preprocessor_1 = make_column_transformer(
                                        (make_pipeline(imp_median,get_customwinsorize, minmaxscaler, power), num_cols),
...
preprocessor_6 = make_column_transformer(
                                        (make_pipeline(imp_median, scaler, minmaxscaler), num_cols),
                                        (make_pipeline(imp_constant, ori_2, get_convert_types_2), cat_cols)
                                      )
# ------------------------------------------------------
# Feature selection
